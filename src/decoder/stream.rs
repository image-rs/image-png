...
mod tests {
    ...
    fn image_gamma() -> Result<(), ()> {
        ...
        trial("f00n0g08.png", None);
        trial("f00n2c08.png", None);
        trial("f01n0g08.png", None);
        trial("f01n2c08.png", None);
        trial("f02n0g08.png", None);
        trial("f02n2c08.png", None);
        trial("f03n0g08.png", None);
        trial("f03n2c08.png", None);
        trial("f04n0g08.png", None);
        trial("f04n2c08.png", None);
        trial("f99n0g04.png", None);
        trial("tm3n3p02.png", None);
        trial("g03n0g16.png", Some(ScaledFloat::new(0.35)));
        trial("g03n2c08.png", Some(ScaledFloat::new(0.35)));
        trial("g03n3p04.png", Some(ScaledFloat::new(0.35)));
        trial("g04n0g16.png", Some(ScaledFloat::new(0.45)));
        trial("g04n2c08.png", Some(ScaledFloat::new(0.45)));
        trial("g04n3p04.png", Some(ScaledFloat::new(0.45)));
        trial("g05n0g16.png", Some(ScaledFloat::new(0.55)));
        trial("g05n2c08.png", Some(ScaledFloat::new(0.55)));
        trial("g05n3p04.png", Some(ScaledFloat::new(0.55)));
        trial("g07n0g16.png", Some(ScaledFloat::new(0.7)));
        trial("g07n2c08.png", Some(ScaledFloat::new(0.7)));
        trial("g07n3p04.png", Some(ScaledFloat::new(0.7)));
        trial("g10n0g16.png", Some(ScaledFloat::new(1.0)));
        trial("g10n2c08.png", Some(ScaledFloat::new(1.0)));
        trial("g10n3p04.png", Some(ScaledFloat::new(1.0)));
        trial("g25n0g16.png", Some(ScaledFloat::new(2.5)));
        trial("g25n2c08.png", Some(ScaledFloat::new(2.5)));
        trial("g25n3p04.png", Some(ScaledFloat::new(2.5)));
        Ok(())
    }
    ...
    fn image_source_chromaticities() -> Result<(), ()> {
        ...
        trial("basi0g01.png", None);
        trial("basi0g02.png", None);
        trial("basi0g04.png", None);
        trial("basi0g08.png", None);
        trial("basi0g16.png", None);
        trial("basi2c08.png", None);
        trial("basi2c16.png", None);
        trial("basi3p01.png", None);
        trial("basi3p02.png", None);
        trial("basi3p04.png", None);
        trial("basi3p08.png", None);
        trial("basi4a08.png", None);
        trial("basi4a16.png", None);
        trial("basi6a08.png", None);
        trial("basi6a16.png", None);
        trial("basn0g01.png", None);
        trial("basn0g02.png", None);
        trial("basn0g04.png", None);
        trial("basn0g08.png", None);
        trial("basn0g16.png", None);
        trial("basn2c08.png", None);
        trial("basn2c16.png", None);
        trial("basn3p01.png", None);
        trial("basn3p02.png", None);
        trial("basn3p04.png", None);
        trial("basn3p08.png", None);
        trial("basn4a08.png", None);
        trial("basn4a16.png", None);
        trial("basn6a08.png", None);
        trial("basn6a16.png", None);
        trial("bgai4a08.png", None);
        trial("bgai4a16.png", None);
        trial("bgan6a08.png", None);
        trial("bgan6a16.png", None);
        trial("bgbn4a08.png", None);
        trial("bggn4a16.png", None);
        trial("bgwn6a08.png", None);
        trial("bgyn6a16.png", None);
        trial("cdfn2c08.png", None);
        trial("cdhn2c08.png", None);
        trial("cdsn2c08.png", None);
        trial("cdun2c08.png", None);
        trial("ch1n3p04.png", None);
        trial("ch2n3p08.png", None);
        trial("cm0n0g04.png", None);
        trial("cm7n0g04.png", None);
        trial("cm9n0g04.png", None);
        trial("cs3n2c16.png", None);
        trial("cs3n3p08.png", None);
        trial("cs5n2c08.png", None);
        trial("cs5n3p08.png", None);
        trial("cs8n2c08.png", None);
        trial("cs8n3p08.png", None);
        trial("ct0n0g04.png", None);
        trial("ct1n0g04.png", None);
        trial("cten0g04.png", None);
        trial("ctfn0g04.png", None);
        trial("ctgn0g04.png", None);
        trial("cthn0g04.png", None);
        trial("ctjn0g04.png", None);
        trial("ctzn0g04.png", None);
        trial("f00n0g08.png", None);
        trial("f00n2c08.png", None);
        trial("f01n0g08.png", None);
        trial("f01n2c08.png", None);
        ...
        trial("f04n2c08.png", None);
        trial("f99n0g04.png", None);
        trial("g03n0g16.png", None);
        trial("g03n2c08.png", None);
        trial("g03n3p04.png", None);
        trial("g04n0g16.png", None);
        trial("g04n2c08.png", None);
        trial("g04n3p04.png", None);
        trial("g05n0g16.png", None);
        trial("g05n2c08.png", None);
        trial("g05n3p04.png", None);
        trial("g07n0g16.png", None);
        trial("g07n2c08.png", None);
        trial("g07n3p04.png", None);
        trial("g10n0g16.png", None);
        trial("g10n2c08.png", None);
        trial("g10n3p04.png", None);
        trial("g25n0g16.png", None);
        trial("g25n2c08.png", None);
        trial("g25n3p04.png", None);
        trial("oi1n0g16.png", None);
        trial("oi1n2c16.png", None);
        trial("oi2n0g16.png", None);
        trial("oi2n2c16.png", None);
        trial("oi4n0g16.png", None);
        trial("oi4n2c16.png", None);
        trial("oi9n0g16.png", None);
        trial("oi9n2c16.png", None);
        trial("PngSuite.png", None);
        trial("pp0n2c16.png", None);
        trial("pp0n6a08.png", None);
        trial("ps1n0g08.png", None);
        trial("ps1n2c16.png", None);
        trial("ps2n0g08.png", None);
        trial("ps2n2c16.png", None);
        trial("s01i3p01.png", None);
        trial("s01n3p01.png", None);
        trial("s02i3p01.png", None);
        trial("s02n3p01.png", None);
        trial("s03i3p01.png", None);
        trial("s03n3p01.png", None);
        trial("s04i3p01.png", None);
        trial("s04n3p01.png", None);
        trial("s05i3p02.png", None);
        trial("s05n3p02.png", None);
        trial("s06i3p02.png", None);
        trial("s06n3p02.png", None);
        trial("s07i3p02.png", None);
        trial("s07n3p02.png", None);
        trial("s08i3p02.png", None);
        trial("s08n3p02.png", None);
        trial("s09i3p02.png", None);
        trial("s09n3p02.png", None);
        trial("s32i3p04.png", None);
        trial("s32n3p04.png", None);
        trial("s33i3p04.png", None);
        trial("s33n3p04.png", None);
        trial("s34i3p04.png", None);
        trial("s34n3p04.png", None);
        trial("s35i3p04.png", None);
        trial("s35n3p04.png", None);
        trial("s36i3p04.png", None);
        trial("s36n3p04.png", None);
        trial("s37i3p04.png", None);
        trial("s37n3p04.png", None);
        trial("s38i3p04.png", None);
        trial("s38n3p04.png", None);
        trial("s39i3p04.png", None);
        trial("s39n3p04.png", None);
        trial("s40i3p04.png", None);
        trial("s40n3p04.png", None);
        trial("tbbn0g04.png", None);
        trial("tbbn2c16.png", None);
        trial("tbbn3p08.png", None);
        trial("tbgn2c16.png", None);
        trial("tbgn3p08.png", None);
        trial("tbrn2c08.png", None);
        trial("tbwn0g16.png", None);
        trial("tbwn3p08.png", None);
        trial("tbyn3p08.png", None);
        trial("tm3n3p02.png", None);
        trial("tp0n0g08.png", None);
        trial("tp0n2c08.png", None);
        trial("tp0n3p08.png", None);
        trial("tp1n3p08.png", None);
        trial("z00n2c08.png", None);
        trial("z03n2c08.png", None);
        trial("z06n2c08.png", None);
        Ok(())
    }
}
